...
// 1 just change some member functions into const
// 2 use type alias to allow sequence to take in any type 
    // try overloading
// 3 use const int DEFAULT_MAX_ITEMS = 160;
    // create an array to store it, dynamically allocated array 
...
class Sequence
{
  public:
    ...
    // other is const Sequence pass by reference 
