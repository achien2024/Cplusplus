...
// same thing as doing m_history = History(nRows, nCols)
    // but doing this at the beggining after : will cause it to contrusct it first before using them
    // uses the history object before 
    // did arena before history but we wanted history before arena 
// creating the arena 
{
